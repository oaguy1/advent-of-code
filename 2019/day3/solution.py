...
def parse_movement(movement: str):
    """
    Given a string representation of a movement, return the directions
    and distance
    """
...
def draw_wires(instructions: List[str]):
    parsed = [ directions.split(",") for directions in instructions ]
    ...
    for instruction in parsed:
        for movement in instruction:
            direction, distance = parse_movement(movement)
